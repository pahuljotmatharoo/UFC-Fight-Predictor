...
const fight_predict = async (fighter1, fighter2, accountid, SetData) => {
      ...
      <div className="predictor-container">
        ...
        <section className="corners">
          <div className="corner red">
            ...
            <div className="stats-grid">
              <div className="stat-card">
                <span className="stat-value">{Data.R_height} inches</span>
                <span className="stat-label">Height</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.R_reach} inches</span>
                <span className="stat-label">Reach</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.R_age}</span>
                <span className="stat-label">Age</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.R_wins} - {Data.R_draws} - {Data.R_losses}</span>
                <span className="stat-label">Record</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.R_strikes}</span>
                <span className="stat-label">Significant Strikes per 10 mins</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.R_takedowns}</span>
          ...
          <div className="corner blue">
            ...
            <div className="stats-grid">
              <div className="stat-card">
                <span className="stat-value">{Data.B_height} inches</span>
                <span className="stat-label">Height</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.B_reach} inches</span>
                <span className="stat-label">Reach</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.B_age}</span>
                <span className="stat-label">Age</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.B_wins} - {Data.B_draws} - {Data.B_losses}</span>
                <span className="stat-label">Record</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.B_strikes}</span>
                <span className="stat-label">Significant Strikes per 10 mins</span>
              </div>
              <div className="stat-card">
                <span className="stat-value">{Data.B_takedowns}</span>
                <span className="stat-label">Takedowns per 10 mins</span>
              </div>
            </div>
          </div>
        ...
        <section className="result">
          <div className="winner-card">
            ...
            <p>
              WIN PROBABILITY: <strong>{String(Math.round(Data.percentage_winner * 100 * 100) / 100)}%</strong>
            </p>
