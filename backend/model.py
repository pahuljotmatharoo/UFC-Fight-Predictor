...
def get_fighter_data(firstName, lastName):
    ...
    temp = response.json()
    result = [temp['Stikes']['accuracy'],
              temp['Takedowns']['accuracy'],
              temp['offense']['submission avg'],
              temp['offense']['sig. str. landed. per min'],
              temp['offense']['takedown avg'],
              temp['record']['wins'],
              temp['record']['losses'],
              temp['record']['draws'],
              temp['physique']['height'],
              temp['physique']['reach'],
              temp['age']]
    return result
